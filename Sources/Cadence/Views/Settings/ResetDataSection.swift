...
struct ResetDataSection: View {
    ...
    var body: some View {
        ...
        .alert("Delete everything in Cadence?", isPresented: $showingConfirm) {
            ...
            Text("Tasks, lists, recent activity, and cached calendar events will be removed from this device and iCloud. The four default lists (Inbox, Personal, Business, Joint Business) come back fresh.")
        }
    }
